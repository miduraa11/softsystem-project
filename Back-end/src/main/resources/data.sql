...
INSERT INTO USER (ID_USER, LOGIN, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD) VALUES (1, 'admin', 'admin@admin', 'Marek', 'Snieżek', 'dupa');
INSERT INTO USER (ID_USER, LOGIN, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD) VALUES (2, 'user1', 'user1@user', 'Marian', 'Paździoch', 'dupa');
INSERT INTO USER (ID_USER, LOGIN, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD) VALUES (3, 'user3', 'user2@user', 'Ferdynand', 'Kiepski', 'dupa');
