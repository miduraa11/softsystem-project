...
INSERT INTO USER (ID_USER, LOGIN, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD) VALUES (1, 'qwe', 'admin@admin', 'Marek', 'Snieżek', 'dupa');
INSERT INTO USER (ID_USER, LOGIN, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD) VALUES (2, 'asd', 'user1@user', 'Marian', 'Paździoch', 'dupa');
INSERT INTO USER (ID_USER, LOGIN, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD) VALUES (3, 'zxc', 'user2@user', 'Ferdynand', 'Kiepski', 'dupa');
INSERT INTO USER (ID_USER, LOGIN, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD) VALUES (4, 'admin', 'adadas@gmail.com', 'Marek', 'Snieżek', '9e38e8d688743e0d07d669a1fcbcd35b');
